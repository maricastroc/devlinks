...
export const PhoneIllustration = ({ user, isSmaller = false }: Props) => {
  ...
  return (
    <div
      className={`relative align-middle ${isSmaller ? 'w-[280px]  h-[510px]' : 'w-[307px] h-[631px]'} rounded-3xl md:shadow-2xl border-8 border-gray-800 ${user?.theme?.styles.background}`}
    >
