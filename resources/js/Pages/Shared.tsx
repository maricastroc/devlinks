...
export default function Shared({ userLinks, user, authUser }: Props) {
  ...
  const renderOwnerHeader = () => {
    ...
    return (
      <header className="z-50 w-full h-[78px] md:p-4 mb-10 md:mb-4">
        <div
  ...
  const renderLinks = () =>
    userLinks?.length > 0 ? (
      <div
        className={`w-full max-h-[15rem] custom-scrollbar overflow-y-scroll md:w-[20rem] mt-10 flex flex-col gap-4`}
      >
  ...
  return (
    ...
    >
      ...
      <div
        className={`z-[12] p-6 lg:mb-30 md:p-10 md:mt-8 mb-20 shadow-lg lg:shadow-xl w-[88vw] max-w-[22rem] md:max-w-[26rem] rounded-xl ${styles.card}`}
      >
