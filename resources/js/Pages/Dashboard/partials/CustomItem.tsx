export const CustomItem = ({ onSelect }: { onSelect: () => void }) => (
  <button
    className="flex w-full items-center justify-between gap-3 p-3 transition-all duration-150 bg-transparent border-b border-gray-200 rounded-lg hover:bg-gray-100"
    onClick={onSelect}
  >
    <div className="flex items-center justify-start gap-4">
      <img
        className="w-10 h-10"
        src="assets/images/icon-color-custom.svg"
