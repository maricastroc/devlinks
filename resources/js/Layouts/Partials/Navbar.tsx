...
export const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between w-full p-6 py-4 pl-2 bg-white shadow-sm md:relative md:top-auto md:left-auto md:right-auto md:w-auto md:m-6 md:rounded-md md:p-5">
      <Link
